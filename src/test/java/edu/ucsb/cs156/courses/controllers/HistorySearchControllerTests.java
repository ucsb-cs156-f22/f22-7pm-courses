...
// import edu.ucsb.cs156.courses.repositories.ArchivedCourseRepository;
...
// import edu.ucsb.cs156.courses.controllers.HistoryCourseSearchController;
...
//         when (
//             convertedSectionCollection.findOneByQuarterAndEnrollCode(
...
//         assertEquals( expectedResult, cp.getClass() );
//     }
...
//         List<ConvertedSection> expectedResult = CoursePage.fromJSON( expectedJSONString ).getClass();
//         String urlTemplate = "/api/public/history/coursesearch?"
//             +      "startQtr=%s"
//             +       "&endQtr=%s"
//             +  "&subjectArea=%s"
